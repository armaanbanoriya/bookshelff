                ...
                <form method="POST" action="{{ url('banner/save') }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="headingtitle" placeholder="Enter Title Heading" class="form-control"
                                id="headingtitle">
                            @error('headingtitle')
                                <span class="text-danger">
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="boldheadingtitle" placeholder="Enter your Bold Heading Title"
                                class="form-control" id="boldheadingtitle">
