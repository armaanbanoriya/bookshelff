...
<head>
    ...
    <link href="{{ asset('admin/pond/filepond.css') }}" rel="stylesheet" />
        ...
        <aside id="letitchange" class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="color: black!important;">
                    <div class="image">
                        <img src="{{ asset('admin/dist/img/armaan.jpg') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                        <a href=" {{ asset('/dashboard') }} " id="#letitchange" class="d-block">Armaan Banoriya</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('subimages/display') }}"
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('product/addproduct') }}"
