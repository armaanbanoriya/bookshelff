                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="coupon_code" value="{{ $data->coupon_code }}" class="form-control"
                                id="exampleInputEmail1" placeholder="Enter Coupon code">
                            @error('coupon_code')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="amount_type"> value="{{ $data->amount_type }}"
                                ...
                                <option value="Percentage" @if ($data->amount_type == 'Percentage') selected @endif>Percentage
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="expiry_date" value="{{ $data->expiry_date }}" class="form-control"
