...
<head>
    ...
    ****************************-->
    ...
    <style>
        ...
        .btnext1:hover::before,
        .btnext2:hover::before {
            height: 180%;
        }

        .btnext3:hover::before,
        .btnext4:hover::before {
            height: 0%;
        }
...
<body>
    ...
    <div id="offcanvas-mobile-menu" class="offcanvas theme3 offcanvas-mobile-menu">
        <div class="inner">
            <div class=" text-left">
                @guest
                    <hr>
                    <a href="{{ url('signin') }}" type="button" class="btn text-left"><span
                            class="menu-text">Login</span></a>
                    <hr>

                    @if (Route::has('register'))
                        <a href="{{ 'signup' }}" type="button" class="btn"><span
                ...
                @else
                    <li>
                        <nav class="offcanvas-menu">
                            <ul>
                                <li><a style="font-size: 20px" href="#"><span
                                            class="menu-text">{{ Auth::user()->name }}</span></a>
    ...
    <div id="offcanvas-cart" class="offcanvas offcanvas-cart scroll theme3">
        <div class="inner">
                ...
                @if (Auth::check())
                    @if ($cart->count() > 0)
                        ...
                        @foreach ($cart as $cartdata)
                            <li>
                                <a href="{{ url('productdetail/' . $cartdata->product_id) }}" class="image"><img
                                        src="{{ url('upload/' . $cartdata->product_image) }}"
                                        alt="Cart product Image"></a>
                                <div class="content">
                                    <a href="{{ url('productdetail/' . $cartdata->product_id) }}"
                                        class="title">{{ $cartdata->product_name }}</a>
                                    <span class="quantity-price">{{ $cartdata->product_quantity }} x <span
                                            class="amount">Rs. {{ $cartdata->product_price }}/-</span></span>
                                    <a href="{{ url('cart/delete/') }}/{{ $cartdata->product_id }}"
                                        class="remove">×</a>
                                </div>
                            </li>
                            @php
                ...
                @else
                    @if ($r->count() > 0)
                        ...
                        @foreach ($r as $cartdata1)
                            <li>
                                <a href="{{ url('productdetail/' . $cartdata1->product_id) }}" class="image"><img
                                        src="{{ url('upload/' . $cartdata1->product_image) }}"
                                        alt="Cart product Image"></a>
                                <div class="content">
                                    <a href="{{ url('productdetail/' . $cartdata1->product_id) }}"
                                        class="title">{{ $cartdata1->product_name }}</a>
                                    <span class="quantity-price">{{ $cartdata1->product_quantity }} x <span
                                            class="amount">Rs. {{ $cartdata1->product_price }}/-</span></span>
                                    <a href="{{ url('cart/delete/') }}/{{ $cartdata1->product_id }}"
                                        class="remove">×</a>
                                </div>
                            </li>
                            @php
            ...
            <a href="{{ url('cart') }}"
                class="btn theme--btn-ddefault btn--lg d-block d-sm-inline-block rounded-5 mr-sm-2">view
                cart</a>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-5 col-lg-2 order-first">
                        <div class="logo text-center text-sm-left mb-30 mb-sm-0">
                            <a href="{{ url('/') }}"><img src="{{ url('front/assets/img/logo/logo.png') }}"
                                    alt="logo"></a>
                        </div>
                    </div>
                    @php
                    ...
                    <div class="col-lg-7 order-1 order-lg-0">
                        <div class="d-flex flex-wrap w-100 align-items-center">
                            <div class="vertical-menu d-none d-lg-block">
                                <button class="menu-btn d-flex"><span class="ion-android-menu"></span>All
                                    Categories<span class="ion-ios-arrow-down d-block ml-auto"></span> </button>.
                                                ...
                                                <li>
                                                    ...
                                                    @foreach ($catproduct->products as $item)
                                                        <ul class="submenu-item">
                                                            <li><a
                                                                    href="{{ url('productdetail/' . $item->id) }}">{{ $item->product_name }}</a>
                                                            </li>
                            ...
                            <div class="search-form width-calc-from-left pl-35 mt-30 mt-lg-0">
                                <form id="search-form" action="{{ url('/searching') }}" method="post"
                                    ...
                                    @csrf
                                    <input
                                        style="border: 2px solid #205fec;
                                border-radius: 28px;
                                border-style: outset;"
                                        class="form-control theme3" id="search_text" type="search"
                                        name="search_product" placeholder="Enter your search key ...">
                                                    ...
                                                    <div class="dropdown-menu logindrop bg- border-warning ">
                                                        <div class="card-menu" style="width: 15rem;">
                                                            <div class="card-body text-success ">
                                                                ...
                                                                <h5 class="text-center"><a href="{{ url('myaccount') }}"
                                                                        class="card-title btn btn-info">My account</a></h5>
                                                                <div class="row">
                                                                    <div class="col">

                                                                        <a href="{{ url('myaccount') }}"
                                                                            class="btn btn-success">My Orders</a>

                                                                        <a href="{{ url('front/logout') }}"
                                                                            class="btn btn-danger"
                                                                            style="position: relative; left: 17px;">Logout</a>
                            ...
                            <div class="address-widget mb-30">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h4 class="title text-dark"><a href="tel:+91 7773007074">(+91) 7773007074</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="nletter-form mb-35">
                                <form method="post" action="" class="form-inline position-relative">
                                    ...
                                    <br>
                                    <textarea name="" placeholder="Enter your message.." class="form-control" cols="30" rows="3"
                                        required></textarea>
                                    <br>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="text-left">
                            <p class="mb-3 mb-md-0">Copyright &copy; <a
                                    href="https://www.linkedin.com/in/armaan-banoriya-b59307108/">Armaan Banoriya</a>.
                                All
                                Rights Reserved</p>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8 mx-auto col-lg-5 mb-5 mb-lg-0">
                            <div class="product-sync-init mb-20">
                                <div class="single-product">
                                    <div class="product-thumb">
                                        <img src="{{ url('front/assets/img/hot-deals/thumb/4.jpg') }}"
                                            alt="product-thumb">
                                    </div>
                                </div>
                                <!-- single-product end -->
                                <div class="single-product">
                                    <div class="product-thumb">
                                        <img src="{{ url('front/assets/img/hot-deals/thumb/5.jpg') }}"
                                            alt="product-thumb">
                                    </div>
                                </div>
                                <!-- single-product end -->
                                <div class="single-product">
                                    <div class="product-thumb">
                                        <img src="{{ url('front/assets/img/hot-deals/thumb/6.jpg') }}"
                                            alt="product-thumb">
                                    </div>
                                </div>
                                <!-- single-product end -->
                                <div class="single-product">
                                    <div class="product-thumb">
                                        <img src="{{ url('front/assets/img/hot-deals/thumb/7.jpg') }}"
                                            alt="product-thumb">
                                    </div>
                                </div>
                                <!-- single-product end -->
                            ...
                            <div class="product-sync-nav">
                                <div class="single-product">
                                    <div class="product-thumb">
                                        <a href="javascript:void(0)"> <img
                                                src="{{ url('front/assets/img/hot-deals/thumb/4.2x.jpg') }}"
                                                alt="product-thumb"></a>
                                    </div>
                                </div>
                                <!-- single-product end -->
                                <div class="single-product">
                                    <div class="product-thumb">
                                        <a href="javascript:void(0)"> <img
                                                src="{{ url('front/assets/img/hot-deals/thumb/5.2x.jpg') }}"
                                                alt="product-thumb"></a>
                                    </div>
                                </div>
                                <!-- single-product end -->
                                <div class="single-product">
                                    <div class="product-thumb">
                                        <a href="javascript:void(0)"><img
                                                src="{{ url('front/assets/img/hot-deals/thumb/6.2x.jp') }}g"
                                                alt="product-thumb"></a>
                                    </div>
                                </div>
                                <!-- single-product end -->
                                <div class="single-product">
                                    <div class="product-thumb">
                                        <a href="javascript:void(0)"><img
                                                src="{{ url('front/assets/img/hot-deals/thumb/7.2x.jp') }}g"
                                                alt="product-thumb"></a>
                                    </div>
                                </div>
                                <!-- single-product end -->
                        ...
                        <div class="col-lg-5 divide-right">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2 mb-md-0">
                                    ...
                                    <h6 class="color"><strong>Dimension: </strong>: <span
                                            class="dmc">40x60cm</span> </h6>
    ...
    <script src="{{ url('front/assets/js/main.js') }}"></script> -->
        ...
        <script>
            function select_payment_method() {
                if ($('.stripe').is(':checked') || $('.cod').is(':checked') || $('.paytm').is(':checked') || $('.razorpay').is(
                        ':checked') || $('.payumoney').is(':checked')) {
                    alert('checked');
                } else {
