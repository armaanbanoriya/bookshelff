        ...
        <div class="row">
            <div class="col-12">
                <ol class="breadcrumb bg-transparent m-0 p-0 align-items-center justify-content-center">
                    ...
                    <li class="breadcrumb-item"><a href="categoryproducts/{id}">{{$as->category_id}}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{$as->product_name}}</li>
                </ol>
            </div>
        </div>
    </div>
